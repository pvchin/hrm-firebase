...
import { hoccols } from "./Export2ExcelDetls";
...
const Export2Excel = React.lazy(() => import("./Export2ExcelHOC"));
...
const Export2ExcelDialog = ({ state, setState, onClose }) => {
  ...
  return (
    <Box>
      <Box p={2}>
        <Heading size="md">HOC EXPORT TO EXCEL DIALOG</Heading>
      </Box>
      {/* <Box>
