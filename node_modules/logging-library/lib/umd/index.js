(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['logging-library'] = {}));
  ...
  class Logger {
      ...
      verbose(...args) {
          this.notifyHandlers(exports.LogLevel.VERBOSE, args);
      }
      debug(...args) {
          this.notifyHandlers(exports.LogLevel.DEBUG, args);
      }
      info(...args) {
          this.notifyHandlers(exports.LogLevel.INFO, args);
      }
      warning(...args) {
          this.notifyHandlers(exports.LogLevel.WARNING, args);
      }
      error(...args) {
          this.notifyHandlers(exports.LogLevel.ERROR, args);
      }
      critical(...args) {
          this.notifyHandlers(exports.LogLevel.CRITICAL, args);
      }
  }
  ...
  class TestHandler extends BaseHandler {
       ...
       */
      constructor(level = exports.LogLevel.VERBOSE) {
          super(level);
