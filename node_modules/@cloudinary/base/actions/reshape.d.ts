 ...
 * img.toURL()
 */
declare function cutByImage(imageSource: ImageSource): CutByImage;
/**
 * @summary action
 ...
 * img.toURL()
 */
declare function distortArc(degrees: number): DistortArcAction;
/**
 * @summary action
 ...
 * img.toURL()
 */
declare function shear(x: number, y: number): ShearAction;
/**
 * @summary action
