 ...
 *
 */
declare function audioFrequency(freq: string | number): AudioFrequencyAction;
/**
 * @summary action
 * @memberOf Actions.Transcode
 ...
 */
declare function audioCodec(codec: string): AudioCodecAction;
/**
 * @summary action
 * @memberOf Actions.Transcode
 ...
 */
declare function streamingProfile(profile: string): StreamingProfileAction;
/**
 * @summary action
 * @memberOf Actions.Transcode
 ...
 */
declare function toAnimated(animatedFormat: AnimatedFormatQualifierValue | string): ToAnimatedAction;
/**
 * @summary action
 * @memberOf Actions.Transcode
