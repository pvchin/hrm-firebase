...
export declare const ACCESSIBILITY_MODES: {
    darkmode: import("@cloudinary/base/actions/effect/colorize").ColorizeEffectAction;
    brightmode: import("@cloudinary/base/actions/effect/colorize").ColorizeEffectAction;
    monochrome: import("@cloudinary/base/actions/effect/EffectActions/SimpleEffectAction").SimpleEffectAction;
    colorblind: import("@cloudinary/base/actions/effect/assistColorBlind").AssistColorBlindEffectAction;
};
/**
